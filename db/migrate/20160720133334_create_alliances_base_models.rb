class CreateAlliancesBaseModels < ActiveRecord::Migration[5.0]
  def change
    ...
    create_table :al_relationships do |table|
    ...
    add_index :al_relationships, [ :g_game_board_id, :h_house_id, :h_peer_house_id ], unique: true, :name => 'al_relationships_unique_index'
    ...
    add_index :al_houses, [ :g_game_board_id, :h_house_id ], unique: true, :name => 'al_houses_unique_index'
    ...
    add_index :al_bets, [ :g_game_board_id, :h_house_id, :h_target_house_id  ], unique: true, :name => 'al_bets_unique_index'
